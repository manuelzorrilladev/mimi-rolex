...
const deskWatchDetails = ref({
  ...
  bisel:
    "Fijo, graduado 60 minutos, disco Cerachrom de cerámica negra resistente a las rayaduras",
...
function getIndividualAccesories() {
  rolexDataService
    .getIndividualAccesories(route.params.id)
    .then((d) => {
        ...
        <div v-if="isReady" class="bg-rolex-brown-light-2">
          ...
          <section class="relative md:h-[85vh]">
            <div class="flex items-center justify-center w-full">
              <img
                :src="`${storageRoute}/rolex-accessories-${accesories.modelo}-packshot.webp`"
                :alt="`${accesories.nombre} imagen principal`"
                class="w-1/2 md:w-[30%]"
              />
            </div>
            ...
            >
              <div class="font-helvetica w-full md:w-[85%]">
                <div class="md:w-1/3">
                  ...
                  <h1 class="font-extralight text-rolex-brown text-sm">
                    {{ accesories.sub }}
                  </h1>
                  <h1 class="font-extralight text-rolex-brown text-sm">
                    {{ accesories.modelo.toUpperCase() }}
                  </h1>
                  <div
                    v-if="!checkLocation"
          ...
          <section class="w-full flex justify-center">
            <div
              v-if="!isClock"
              class="w-10/12 bg-rolex-brown-light-1 grid grid-cols-2 md:grid-cols-3 gap-8 p-10 md:p-20"
            >
              <header class="">
                <h2 class="text-rolex-brown font-helvetica font-bold">RMC</h2>
              ...
              <header class="">
                ...
                <p class="font-light text-sm">Accesorios Rolex</p>
              </header>
              <header class="">
                <h2 class="text-rolex-brown font-helvetica font-bold">
                  Modelo
            ...
            >
              ...
              <header class="">
                <h2 class="text-rolex-brown font-helvetica font-bold">Bisel</h2>
                <p class="font-light text-sm">
          ...
          <section class="bg-rolex-brown-light-2 py-[10vh]">
            ...
            <div class="flex justify-center">
              <img
                :src="`${storageRoute}/rolex-accessories-${accesories.modelo}-landscape.webp`"
                :alt="`Accesorios rolex RMC ${accesories.modelo}`"
                class="hidden md:block w-1/2"
              />
              <img
                :src="`${storageRoute}/rolex-accessories-${accesories.modelo}-portrait.webp`"
                :alt="`Accesorios rolex RMC ${accesories.modelo}`"
          ...
          <section
            class="w-full overflow-hidden pb-[10vh] bg-rolex-brown-light-2"
          >
          ...
          >
            <div class="w-10/12">
              <SectionNavigationCard
                :img="`banners/new-banner-accesorios`"
