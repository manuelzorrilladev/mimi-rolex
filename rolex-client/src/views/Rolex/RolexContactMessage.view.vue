      ...
      <template #content>
        ...
        <main class="w-full overflow-hidden">
          <div :class="position" class="flex w-[300%] duration-300">
            ...
            >
              ...
              >
                ...
                <p class="w-10/12 lg:w-1/2 text-xl font-helvetica font-light">
                  ...
                  introduzca su mensaje a continuación y estaremos encantados de
                  ayudarle.
                </p>
            ...
            <section
              v-if="sliderCount === 2"
              class="border bg-rolex-brown-light-2 pt-[10vh] w-1/3"
            >
              <div>
                <header
                ...
                >
                  ...
                  <h1 class="text-2xl md:text-5xl w-10/12 md:w-1/2">Gracias</h1>
